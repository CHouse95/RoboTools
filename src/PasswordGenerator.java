public class PasswordGenerator {
	static int i = 0;
	public static String GetNewPassword_all(String oldPassword) {
		int j = 0, k = 0;
		String zero = "0";
		i = 0;
	...
	public static String GetNewPassword_some(String oldPassword) {
		int j = 0, k = 0;
		String zero = "0";
		i = 0;
		while(k < oldPassword.length()){
	...
	public static String GetNewPassword_none(String oldPassword) {
		int j = 0, k = 0;
		String zero = "0";
		i = 0;
		while(k < oldPassword.length()){
